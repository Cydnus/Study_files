...
namespace MySql_example
{
    class DB
    {
        ...
        public DataTable SqlSelectAll(string strSQLQuery)
        {
            if( Open() == true)
            {
        ...
        public void SqlInputUpdate(string strSQLQuery, int plusEaValue)
        {
            if (Open() == true)
            {
                MySqlCommand cmd = new MySqlCommand(strSQLQuery, DBconnection);
        ...
        public bool SqlOutputUpdate(string strSQLQuery, int plusEaValue)
        {
            if (Open() == true)
            {
                MySqlCommand cmd = new MySqlCommand(strSQLQuery, DBconnection);
